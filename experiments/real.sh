cd ..
make
sage trees_generation.sage 5 13 17 --gm-add=100 > d8_re_trees.log 2>&1
...
sage trees_generation.sage 5 13 17 29 --gm-add=100 > d16_re_trees.log 2>&1
...
sage trees_generation.sage 5 13 17 29 37 --gm-add=100 > d32_re_trees.log 2>&1
...
sage trees_generation.sage 5 13 17 29 37 41 --gm-add=100 > d64_re_trees.log 2>&1
