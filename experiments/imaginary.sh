cd ..
make
sage trees_generation.sage -3 -7 -11 --gm-add=100 > experiments/d8_im_trees.log 2>&1
...
sage trees_generation.sage -3 -7 -11 -19 --gm-add=100 > experiments/d16_im_trees.log 2>&1
...
sage trees_generation.sage -3 -7 -11 -19 -23 --gm-add=100 > experiments/d32_im_trees.log 2>&1
...
sage trees_generation.sage -3 -7 -11 -19 -23 -31 --gm-add=100 > experiments/d64_im_trees.log 2>&1
