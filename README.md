...
# How to use
1. Set the target field in the file trees_generation.sage (```food``` variable). Alternatively, you can pass d_1 d_2 ... d_n as command line arguments to the script in the next step.
